...
lavaan.model.transversal.tag <-function(){}

lavaan.model.transversal <-'
...
Item.1.t1 ~~ 1*Item.1.t1 + 0*Item.2.t1 + 0*Item.3.t1 + 0*Item.4.t1 
Item.2.t1 ~~ 1*Item.2.t1 + 0*Item.3.t1 + 0*Item.4.t1 
Item.3.t1 ~~ 1*Item.3.t1 + 0*Item.4.t1
Item.4.t1 ~~ 1*Item.4.t1 
'
